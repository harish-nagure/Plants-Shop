    ...
    <div className='add'>
        <form className='flex-col' onSubmit={onSubmitHandle}>
            ...
            <div className="add-product-description flex-col">
                ...
                <textarea onChange={onChangeHandler} value={data.description} name="description" rows="7" placeholder='Write description here' required></textarea>
            </div>
            <div className="add-category-price">
                <div className="add-category flex-col">
                    ...
                    <select onChange={onChangeHandler} value={data.category} name="category">
                        ...
                        <option value="Flowering Plants">Flowering</option>
                        <option value="Succlents Plants">Succlent</option>
                    </select>
                </div>
